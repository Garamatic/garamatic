...
[![CI — Dev](https://github.com/Garamatic/garamatic/actions/workflows/ci-dev.yml/badge.svg?branch=dev)](https://github.com/Garamatic/garamatic/actions/workflows/ci-dev.yml)
[![CI — Test/Acc](https://github.com/Garamatic/garamatic/actions/workflows/ci-test.yml/badge.svg?branch=test)](https://github.com/Garamatic/garamatic/actions/workflows/ci-test.yml)
[![CI/CD — Production](https://github.com/Garamatic/garamatic/actions/workflows/ci-prod.yml/badge.svg?branch=main)](https://github.com/Garamatic/garamatic/actions/workflows/ci-prod.yml)
[![CD — Deploy](https://github.com/Garamatic/garamatic/actions/workflows/cd.yml/badge.svg)](https://github.com/Garamatic/garamatic/actions/workflows/cd.yml)

| Branch | Environment | Pipeline |
|--------|-------------|----------|
| `dev` | Development | Lint + Secret Scan |
| `test`/`acc` | Staging | Full Tests + Smoke + Contract |
| `main` | Production | Tests + Build + Push + Deploy |
...
| `mcp.<domain>` | `http://agentic-mcp:3001` | 3002 |
| `monitor.<domain>` | `http://grafana:3000` | 3000 |
| `prometheus.<domain>` | `http://prometheus:9090` | 9090 |
| `loki.<domain>` | `http://loki:3100` | 3100 |
| `tempo.<domain>` | `http://tempo:3200` | 3200 |
