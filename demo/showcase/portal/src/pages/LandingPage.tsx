        ...
        <div className="container-page py-12 md:py-20">
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-accent flex items-center justify-center text-white font-bold text-xl">
                D
              </div>
              <div>
                ...
                <p className="text-text-secondary">Ville de Desgoffe</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {services.map((service) => (
            <div
              ...
              onClick={() => navigate('/submit')}
            >
              <div className="w-10 h-10 rounded-lg bg-accent-subtle flex items-center justify-center text-accent mb-4 group-hover:bg-accent group-hover:text-white transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step) => (
              <div key={step.number} className="flex gap-4">
                <span className="text-2xl font-bold text-accent shrink-0 leading-none">
                  {step.number}
                </span>
                <div>
