...
check_http "Event Planner"     "http://localhost:8088"                 "200"
...
check_http "API Desgoffe"     "http://localhost:5081/health"          "200"
check_http "API Whitman"      "http://localhost:5082/health"          "200"
check_http "API Liberty"      "http://localhost:5083/health"          "200"
check_http "API Hennessey"    "http://localhost:5084/health"          "200"
check_http "Portal Desgoffe"  "http://localhost:8081"                 "200"
check_http "Portal Whitman"   "http://localhost:8082"                 "200"
check_http "Portal Liberty"   "http://localhost:8083"                 "200"
check_http "Portal Hennessey" "http://localhost:8084"                 "200"
echo ""
